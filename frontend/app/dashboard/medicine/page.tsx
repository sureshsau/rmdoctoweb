...
export default function MedicineStorePage() {
    ...
    async function loadMedicines() {
        ...
        try {
            ...
            if (res && res.data) {
                // Flatten if paginated structure differs, but typically data is the array
        ...
        <div className="min-h-screen bg-gray-50 pb-20 relative">
            ...
            <div className="bg-white sticky top-0 z-30 shadow-sm border-b border-gray-100 px-4 py-3">
                <div className="flex items-center gap-3 mb-3">
                    ...
                    {/* Mobile Cart Icon */}
                    <Link href="/dashboard/medicine/cart" className="relative p-2.5 bg-cyan-50 text-cyan-700 rounded-xl hover:bg-cyan-100 transition md:hidden">
