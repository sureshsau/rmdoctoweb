...
import { 
    Pill, Plus, Trash2, Search, X, Image as ImageIcon, Upload, 
    AlertCircle, XCircle, Edit2, IndianRupee, Layers, Building2, 
    Settings, Package, Tag, FlaskRound as Flask 
} from "lucide-react";
...
export default function ReceptionistMedicinePage() {
    ...
    return (
        <div className="space-y-6 max-w-7xl mx-auto p-2 sm:p-4">
            ...
            {/* Add/Edit Modal - Same as Admin Version */}
            {showAddModal && (
